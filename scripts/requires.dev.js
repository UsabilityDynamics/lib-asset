...
!function(global) {
   ...
   */
     ...
     */
        function c(a, c, d) {
            ...
            q = getOwn(x.pkgs, c) ? p = [ c ] : p.slice(0, p.length - 1), a = q.concat(a.split("/")), 
            b(a), //Some use of packages may use a . path to reference the
            ...
            a = a.substring(2))), d && r && (p || s)) {
                for (h = a.split("/"), i = h.length; i > 0; i -= 1) {
                    if (k = h.slice(0, i).join("/"), p) //Find the longest baseName segment match in the config.
        ...
        function e(a) {
            ...
            return b && isArray(b) && b.length > 1 ? (//Pop off the first array value, since it failed, and
            //retry
            b.shift(), u.require.undef(a), u.require([ a ]), !0) : void 0;
        }
     ...
     */
        function g(a, b, d, e) {
            ...
            h = getOwn(C, k)), //Account for relative paths if there is a base name.
            a && (k ? //Plugin is loaded, use its normalize method.
            o = h && h.normalize ? h.normalize(a, function(a) {
                return c(a, l, e);
            }) : c(a, l, e) : (//A regular module.
       ...
       */
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(d), i(d, "defined", bind(this, function(d) {
                    ...
                    d.normalize && (m = d.normalize(m, function(a) {
                        return c(a, n, !0);
                    ...
                    })), k = getOwn(y, f.id), k && (//Mark this as a dependency for this plugin, so it
                    //can be traced for cycles.
                    this.depMaps.push(f), this.events.error && k.on("error", bind(this, function(a) {
                        this.emit("error", a);
            ...
            enable: function() {
                ...
                each(this.depMaps, bind(this, function(a, b) {
                    ...
                    if ("string" == typeof a) {
                        ...
                        this.depMaps[b] = a, e = getOwn(v, a.id)) return this.depExports[b] = e(this), void 0;
       ...
       */
            configure: function(a) {
                ...
                a.shim && (eachProp(a.shim, function(a, b) {
                    ...
                    c[b] = a;
                }), x.shim = c), //Adjust packages if necessary.
                a.packages && (each(a.packages, function(a) {
                    var c;
                    a = "string" == typeof a ? {
                        name: a
                    } : a, c = a.location, //Create a brand new object on pkgs, since currentPackages can
            ...
            makeRequire: function(b, e) {
                function f(c, d, i) {
                    ...
                    "string" == typeof c ? isFunction(d) ? j(makeError("requireargs", "Invalid require call"), i) : //If require|exports|module are requested, get the
       ...
       */
            nameToUrl: function(a, b, c) {
                ...
                k = a + (b || ""); else {
                    ...
                    d = x.paths, e = x.pkgs, h = a.split("/"), i = h.length; i > 0; i -= 1) {
   ...
   */
        req = requirejs = function(a, b, c, d) {
            ...
            a = b, b = c, c = d) : a = []), f && f.context && (g = f.context), e = getOwn(contexts, g), 
            e || (e = contexts[g] = req.s.newContext(g)), f && e.configure(f), udx.dynamic_loading.call(e, a, b, c), 
            e.require(a, b, c);
        }, /**
   ...
   */
        req.load = function(a, b, c) {
            ...
            d.setAttribute("data-requiremodule", b), //Set up load listener. Test attachEvent first because IE9 has
            ...
            d.addEventListener("error", a.onScriptError, !1)) : (//Probably IE. IE (at least 6-8) do not fire
            //script onload right after executing the script, so
            //we cannot tie the anonymous define call to a name.
            //However, IE reports the script as being in 'interactive'
            //readyState at the time of the define call.
            useInteractive = !0, d.attachEvent("onreadystatechange", a.onScriptLoad)), d.src = c, 
            //For some cache cases in IE 6-8, the script executes before the end
            //of the appendChild execution, so to tie an anonymous define
            //call to the module name (which is stored on the node), hold on
            //to a reference to this node, but clear after the DOM insertion.
            currentlyAddingScript = d, baseElement ? head.insertBefore(d, baseElement) : head.appendChild(d), 
        ...
        eachReverse(scripts(), function(a) {
            ...
            //baseUrl.
            src = mainScript.split("/"), mainScript = src.pop(), subPath = src.length ? src.join("/") + "/" : "./", 
            cfg.baseUrl = subPath), //Strip off any trailing .js since mainScript is now
            //like a module name.
